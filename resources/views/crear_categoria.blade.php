    ...
    <form action="/crear_categoria" method="post">
        ...
        <div class="d-flex flex-wrap justify-content-center mx-5 mt-4">
            ...
            <div class="container">
                ...
                <input type="text" id="inputTexto2" name="palabras_clave" class="form-control mb-3">
            </div>
            
            <div class="container">
                <label for="texto2" class="form-label">Descripción</label>
                <textarea id="texto2" name="descripcion" class="form-control mb-3 w-100" rows="5"></textarea>
            </div>   
        </div>
        
        <!-- Botón centrado para enviar el formulario -->
        <div class="d-flex justify-content-center mb-4">
            <button type="submit" class="btn btn-lg btn-dark w-25 p-3">Crear categoría</button>
        </div>
    </form>
